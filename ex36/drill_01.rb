...
puts "****** WELCOME TO THE WIZZARD-TO-BE GAME. PRESS ANY KEY TO START. ******"
any_key = $stdin.gets.chomp
def stars()
  puts '-' * 50
end

puts "Your coach stops and, as you get off, an elderly, sophisticated lady - supposedly a witch - approaches you and says: 'Welcome to Wandland! You have travelled a long way, as you have been admitted to the Wizzard-to-be school! Follow this path. You don't want to be late for your first lesson, do you?'"
stars
...
stars
  def reception_room
    ...
    if password == "chilliconcarne"
      ...
      stars
      puts "'Sorry, you may not get in. Come back with the password, little monkey!', says the wizzy."
      stars
      start
    end
  end
  ...
  def apprentice_room
    ...
    stars
    puts "Press 1 for: 'Can't help you mate, I'm late for my first class! Help me!'\nPress 2 for: 'Mmhf 'kay, I'll help you.'"
    print "> "
    choice = $stdin.gets.chomp

    if choice == "1"
      puts "He kicks you out. Bloody hell!"
      start
    elsif choice == "2"
      stars
      puts "It takes you some time, but you find Mourticious's glasses. He tells you the following: 'Thank you! You've passed the test. The password to the classroom is: chilliconcarne.'"
      stars
      start
    else
  ...
  def classroom
    ...
    if pie == "1"
      ...
      stars
      puts "The Mad Hatter eats a slice, and dies within seconds. Good job!"
      stars
      exit(0)
    else
      puts "Sorry, I don't understand your choice."
